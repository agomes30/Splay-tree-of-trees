 ...
 * Description: Header file for the Scanner class
 ************************************************************************/
...
private:
  ...
  // *************************************************
  SNode* RemoveSplayTree(SNode* ptr); //removes the splay tree
  SNode* copy(SNode *ptr);
  SNode* splay(SNode *ptr, int weight);
  SNode* rightRotate(SNode *ptr);
  SNode* leftRotate(SNode *ptr);

  void inOrder(SNode* itr) const;
  void dumpHelp(SNode* itr) const;
};
